...
- 버전: `1.3.6` (Android `versionCode` 14)
...
`main` 푸시 시 GitHub Actions가 릴리스 APK를 만듭니다. 최신 파일은 [Releases](https://github.com/wldghs5s-max/jungcheogi-trainer/releases)의 `v1.3.6`에서 받으면 됩니다. 예전에 EAS로 설치한 앱과 서명이 다를 수 있어, 덮어씌우기 전에 기존 앱을 지운 뒤 설치하세요.
